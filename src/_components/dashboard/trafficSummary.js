...
const TrafficSummary = () => {
  const optionGraph = {
    options: {
      ...
      colors: ["#0054a6", "rgba(0, 84, 166, 0.8)", "rgba(47, 179, 68, 0.8)"],
      legend: {
        show: false,
      },
    },
    series: [
      ...
      },
      {
        name: "Social",
        data: [
          2, 5, 4, 3, 3, 1, 4, 7, 5, 1, 2, 5, 3, 2, 6, 7, 7, 1, 5, 5, 2, 12, 4,
  ...
  return (
    <div className="card overflow-hidden">
      <div className="card-body">
        ...
        <Chart
          type="bar"
          series={optionGraph.series}
          options={optionGraph.options}
          height={optionGraph.options.chart.height}
        />
      </div>
    </div>
  );
